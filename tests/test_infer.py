...
class TestPossibleCluesFromPlacements(unittest.TestCase):

    def setUp(self) -> None:
        PLAYER_1 = Player("red", clues.by_booklet_entry("alpha", 2), teamname="alpha")
        PLAYER_2 = Player("orange", None, teamname="beta")
    ...
    def test_defaults_to_return_all_clues(self) -> None:
        ...
        possible_clues = infer.possible_clues_from_placements(self.game.map, player.cubes, player.disks)
