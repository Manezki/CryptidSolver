...
class TestMapGeneration(unittest.TestCase):
    ...
    def test_structures_assigned_to_correct_coordinates(self) -> None:
        ...
        for structure in STRUCTURES:
            ...
            self.assertTrue(
                contains_structure,
                "A structure coordinates did not match the coordinates of the map",
            )
    ...
    def test_structure_color_matching(self) -> None:
        ...
        for structure in STRUCTURES:
            ...
            self.assertEqual(
                ...
                "The color of the structure list and gamemap does not match",
            )
    ...
    def test_structure_type_matching(self) -> None:
        ...
        for structure in STRUCTURES:
            ...
            self.assertEqual(
                ...
                "The shape of the listed structures and gamemap does not match",
            )
