...
class TestMapTile(unittest.TestCase):
    def test_succesfully_conver_from_BiomeTile_with_animal(self) -> None:
        ...
        self.assertEqual(
            ...
            "F",
            msg=(
                "The biome of the converted tile should be the same as the"
                " biome tile's."
            ),
        )
        self.assertEqual(
            ...
            "cougar",
            msg=(
                "The animal of the biome tile's should be present in converted"
                " MapTile."
            ),
        )
        self.assertEqual(
            converted.x,
            1,
            msg="The x coordinate should not change during the conversion.",
        )
        self.assertEqual(
            converted.y,
            2,
            msg="The y coordinate should not change during the conversion.",
        )
